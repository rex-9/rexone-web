  ...
  static readonly client = {
    ...
    protected: {
      ...
      admin: {
        ...
        USERS_RECYCLE_BIN: AppRoutes.admin('/users/recycle-bin'),
        ...
        PRODUCTS_RECYCLE_BIN: AppRoutes.admin('/products/recycle-bin'),
  ...
  static readonly server = {
    ...
    protected: {
      ...
      admin: {
        ...
        DISCARDED_PAYMENT_PRODUCTS: AppRoutes.adminApi('/payment/products/discarded'), // GET
        PAYMENT_PRODUCT_DETAIL: AppRoutes.adminApi('/payment/products/:id'), // GET, PATCH, DELETE
        PAYMENT_PRODUCT_UNDISCARD: AppRoutes.adminApi('/payment/products/:id/undiscard'), // POST
