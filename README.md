...
- **Title & Description**: Admin list, children table, picker, detail, and edit use Core `title` (fallback storage `name`) and optional `description`. Edit persists both through `PUT /v1/admin/assets/:id`.
...
| Protected | `/admin/assets/:id`                 | Asset detail (title, description, thumbnail, subtitle)  |
| Protected | `/admin/assets/:id/edit`            | Asset edit (title, description, compression, thumbnail, subtitle)  |
