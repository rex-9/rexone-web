...
- **Molecules & Overlays**:
  ...
  - Common & Media: `NavBar`, `HeadNavbar`, `Badge`, `ProfileAvatar`, `Typography`, `TextLink`, `Asset` / `Image`, `Player` (Vidstack + optional SRT tracks). Strictly zero raw `<img>`, `<video>`, or `<a>` tags.
